    ...
    <div class="cartbody">
      ...
      <div class="cartLi">
        ...
        >
          <van-card
            num="1"
            :price="item2.result.itemInfo.lowNowPrice"
            :desc="item2.result.itemInfo.title"
            :title="item2.result.skuInfo.title"
            class="goods-card"
            :thumb="item2.result.itemInfo.topImages[0]"
          >
          </van-card>
          <!-- 商品按钮 -->
          <van-checkbox
...
export default {
  ...
  created() {
    this.goods = JSON.parse(window.localStorage.getItem("di"));
